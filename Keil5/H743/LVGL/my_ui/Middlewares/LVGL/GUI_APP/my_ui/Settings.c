...
lv_obj_t* Settings_destroy_cb(struct activity_t* activity) {return 0;}
lv_obj_t* Settings_pause_cb(struct activity_t* activity) {return 0;}
lv_obj_t* Settings_resume_cb(struct activity_t* activity) {return 0;}
