...
/* 内存池(64字节对齐) */
static uint8_t mem1base[MEM1_MAX_SIZE] __attribute__((aligned(64)));							//D1域AXI SRAM = 512KB
static uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((section(".sdram_pool"), aligned(64)));	//外部SDRAM
static uint8_t mem3base[MEM3_MAX_SIZE] __attribute__((section(".sram12_pool"), aligned(64)));	//D2域AHB SRAM1,AHB SRAM2 = 256K
...
static MT_TYPE mem4mapbase[MEM4_ALLOC_TABLE_SIZE] __attribute__((section(".sram4_map")));		/* 内部SRAM4内存池MAP */
static MT_TYPE mem5mapbase[MEM5_ALLOC_TABLE_SIZE] __attribute__((section(".dtcm_map")));		/* 内部DTCM内存池MAP */
static MT_TYPE mem6mapbase[MEM6_ALLOC_TABLE_SIZE] __attribute__((section(".itcm_map")));		/* 内部ITCM内存池MAP */
#endif
