...
/* GT9XXX芯片IIC读写命令 */
#define use_CMD_2829	/* 根据芯片设定,这里gt1158使用2829 */

#ifdef use_CMD_2829
#define GT9XXX_CMD_WR       0X28        /* 写命令 */
#define GT9XXX_CMD_RD       0X29        /* 读命令 */
#else
#define GT9XXX_CMD_WR       0xBA        /* 写命令 */
#define GT9XXX_CMD_RD       0xBB        /* 读命令 */
#endif
/* GT9XXX 部分寄存器定义  */
