...
#define CT_IIC_SCL_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOH_CLK_ENABLE(); }while(0)    /* PH端口钟使能 */

#define CT_IIC_SDA_GPIO_PORT              GPIOI
#define CT_IIC_SDA_GPIO_PIN               GPIO_PIN_3
#define CT_IIC_SDA_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOI_CLK_ENABLE(); }while(0)    /* PI端口时钟使能 */
